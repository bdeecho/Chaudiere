...
\>Echo est une association visant à promouvoir la musique électronique sur les différents sites de l'Université de Cergy-Pontoise, au travers d'événements variés : Ateliers de découverte du DJing, promotion d'artistes étudiants, apéritifs "open-platines", et _Cadences_.
